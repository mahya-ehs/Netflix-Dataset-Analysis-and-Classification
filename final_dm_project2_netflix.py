# -*- coding: utf-8 -*-
"""final-DM-project2-netflix.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1znQy8vVh7oFRdty2Ssx5OdMr9CHNfry0
...
for field in numeric_fields:
    ...
    # Set color for the whiskers, caps, and medians
...
# field_outliers.shape    #718 - (low: 2004, upper: 2028)

df['release_year'].min()

"""**convert numerical to categorical**"""

bins = [1920, 1930, 1940, 1950, 1960, 1970, 1980, 1990, 2000, 2010, 2020, 2030]  # Define custom bin boundaries
labels = ['20s', '30s', '40s', '50s', '60s', '70s', '80s', '90s', '2000s', '2010s', '2020s']  # Define corresponding labels
...
# Plot the records based on decades with colors and effects
...
# Add grid lines and set a custom background color
...
# Plotting the proportions of directors above and below average
...
for transaction in transactionsList:
    cast_list = transaction[1].split(', ')
    listed_in_list = transaction[2].split(', ')
...
**description embeding using BERT**
"""
...
print("Number of unique genres:", num_unique_values)

unique_values

"""**DBSCAN clustering for knowing the number of clusters**"""
...
# Extract the first genre from the 'listed_in' column and select it as the label
df['label'] = df['listed_in'].str.split(',').str[0].str.strip()

"""**multi-label classifying (1-hot vectors)**"""
...
"""**Using BERT to vectorize description**"""
...
df['embeddings'] = description_vectors.tolist()
...
X_train, X_test, y_train, y_test = train_test_split(reduced_vectors, df['label'], test_size=0.2, random_state=42)
